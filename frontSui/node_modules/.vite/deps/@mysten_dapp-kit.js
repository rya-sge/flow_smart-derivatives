...
function useLatestRef(value2) {
  const ref = React28.useRef(value2);
  index(() => {
    ref.current = value2;
  });
  return ref;
...
var MenuRadioGroup = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(RadioGroupProvider, { scope: props.__scopeMenu, value: value2, onValueChange: handleValueChange, children: (0, import_jsx_runtime13.jsx)(MenuGroup, { ...groupProps, ref: forwardedRef }) });
  }
);
...
function parseSerializedSignature(serializedSignature) {
  ...
  switch (signatureScheme) {
    ...
    case "Secp256r1":
      ...
      const signature = bytes2.slice(1, bytes2.length - size4);
...
var _LRUCache = class _LRUCache {
  ...
  *rvalues() {
  ...
  set(k, v2, setOptions = {}) {
    ...
    const size4 = __privateGet(this, _requireSize).call(this, k, v2, setOptions.size || 0, sizeCalculation);
...
initializeSizeTracking_fn = function() {
  ...
  __privateSet(this, _requireSize, (k, v2, size4, sizeCalculation) => {
    if (__privateMethod(this, _LRUCache_instances, isBackgroundFetch_fn).call(this, v2)) {
      return 0;
    }
    if (!isPosInt(size4)) {
